...
This project uses the [Lending Club Loan Data](https://www.kaggle.com/datasets/wordsforthewise/lending-club) dataset from Kaggle. The raw dataset is not included in this repo — download it directly from Kaggle to reproduce the analysis.
